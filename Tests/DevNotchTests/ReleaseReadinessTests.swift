...
final class ReleaseReadinessTests: XCTestCase {
    ...
    func testReadmeContainsSecurityOpeningInstructions() throws {
        ...
        XCTAssertTrue(readme.contains("DevNotch-1.1.3.dmg"), "README must reference DevNotch-1.1.3.dmg")
    ...
    func testHelperSigningConsistencyConfiguration() throws {
        ...
        XCTAssertTrue(projectYml.contains("MARKETING_VERSION: \"1.1.3\""))
    ...
    func testInstallTextAndReleaseArtifactsDocs() throws {
        ...
        XCTAssertTrue(notesText.contains("Dev Notch 1.1.3"))
        ...
        XCTAssertTrue(checklistText.contains("DevNotch-1.1.3.dmg"))
    }
}
